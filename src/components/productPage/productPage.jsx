...
export default function ProductPage(props) {
    ...
    const [ viewWidth , setViewWidth] = useState("50vw")
    ...
    useEffect(() => {
        ...
        screenWidth <= 900 ? setViewWidth("90vw") :setViewWidth("50vw");
        ...
        <div className='topPart'>
            ...
            {isLoading ? <div className='productCarousel skeleton'></div> :
                <div className='productCarousel'>
                    ...
                    <Carousel list={imgListTemp} height="60vh" width={viewWidth} marginTop="25vh" borderRadii="0px" autoPlay="true" />
                </div>}
            ...
            {isLoading ? <div className='productSingleTopTitleMain skeleton'></div> :
                <div className='productSingleTopTitleMain'>
                    <div className='productSingleTopTitle'>
                        ...
                        <div className='productSinglePriceTagMain' >
